...
The subscription service authenticates here with a secret of its own, distinct
from the one guarding the subscription API: sharing a network is not a reason to
share trust.
"""
...
_api_key_scheme = APIKeyHeader(
    name=API_KEY_HEADER,
    auto_error=False,
    description="Chave de API do serviço de orçamentos.",
)
