...
async def init_database() -> None:
    ...
    Deliberately simple for this MVP: there is a single table and no schema
    evolution to replay. A production service would version the schema with
    Alembic instead.
    """
    from app.models import budget  # noqa: F401 - registra o modelo no metadata
